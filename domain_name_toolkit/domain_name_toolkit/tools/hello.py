...
@tool
def check_domain_expiry(domain: Annotated[str, "The domain name to check (e.g., 'example.com')"]) -> dict:
    ...
    try:
        ...
        return {
            ...
            "expires_soon": days_until_expiry <= 30,  # Within 30 days
...
@tool
def check_ssl_expiry(domain: Annotated[str, "The domain name to check SSL certificate (e.g., 'example.com')"]) -> dict:
