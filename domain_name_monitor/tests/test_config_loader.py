...
from config_loader import (
    ConfigLoader, DomainMonitorConfig, DomainConfig, EmailRecipient,
    MonitoringConfig, EmailConfig, SlackConfig, NotificationConfig,
    AdvancedConfig, load_config
)
...
class TestConfigLoader:
    ...
    def test_load_yaml_config(self, test_yaml_config):
        ...
        assert config.notifications.email.subject_template == 'Test Alert - {count} domains'
    ...
    def test_save_config(self):
        ...
        config.domains = [
            ...
            DomainConfig(name="test2.com", description="Test 2", alert_threshold_days=45)
        ]
        ...
        try:
            ...
            assert loaded_config.notifications.email.recipients[0].email == "test@example.com"
